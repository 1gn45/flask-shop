...
toolinputdata = {
    ...
    "vendor": "who manufacture this",
    "D1": "tool diameter",
    "D2": "tool holder diameter",
    "flutes": "number of flutes",
    "L2": "tool flute length",
    "L3": "tool max working depth",
    "L1": "tool length",
    "R": "tool radius",
    "angle": "drill angle",
...
def addtoolfromlibrary():
    ...
    if counter > 1:
        ...
        selectedtool["post-process"]["number"] = toolholdernumber(
            selectedtool["geometry"]["DC"], selectedtool["type"]
        )
